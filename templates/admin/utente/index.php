...
<body>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center gap-1">
                        ...
                        <button class="btn btn-outline-danger btn-remove-user d-flex align-items-center gap-1" data-bs-toggle="modal" data-bs-target="#removeModal" data-user-id="<?= $row['id'] ?>">
    ...
    <script>
        const removeUserForms = document.getElementsByClassName('btn-remove-user');

        Array.prototype.forEach.call(removeUserForms, button => {
            button.addEventListener('click', () => {
                document.getElementById('id-input-remove-definetly').value = button.dataset['userId'];
            });
        });
    </script>
